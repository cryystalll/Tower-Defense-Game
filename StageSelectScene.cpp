...
void StageSelectScene::Initialize() {
    ...
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Setting", "pirulen.ttf", 36, halfW+550, halfH * 3 / 2+60, 0, 0, 0, 255, 0.5, 0.5));
    // TODO 1 (3/3): Move the sliderBGM, sliderSFX to the setting Scene and make sure the background music will be played
//    Slider *sliderBGM, *sliderSFX;
//    sliderBGM = new Slider(40 + halfW - 95, halfH - 50 - 2, 190, 4);//滑方塊
...
void StageSelectScene::SettingOnClick(int stage) {
        ...
        Engine::GameEngine::GetInstance().ChangeScene("newselect");
