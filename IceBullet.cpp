...
IceBullet::IceBullet(Engine::Point position, Engine::Point forwardDirection, float rotation, Enemy* parent) :
...
//IceCreamBullet::IceCreamBullet(Engine::Point position, Engine::Point forwardDirection, float rotation, Enemy* parent) :
//    Bullet("play/bullet-1.png", 500, 1, position, forwardDirection, rotation - ALLEGRO_PI / 2, parent) {
//    // TODO 2 (1/8): You can imitate the 2 files: 'FireBullet.hpp', 'FireBullet.cpp' to create a new bullet.
//}
void IceBullet::OnExplode(Turret* turret) {
